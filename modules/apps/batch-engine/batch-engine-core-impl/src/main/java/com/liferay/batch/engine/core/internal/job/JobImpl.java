...
import com.liferay.batch.engine.core.job.JobExecutionListener;
...
public class JobImpl implements Job {
	...
	private Void _execute(JobExecution jobExecution) throws Exception {
		try {
			...
			_finishBatchJob(jobExecution.getBatchJob(), BatchStatus.COMPLETED);

			_executeAfterJobListeners(jobExecution);
		}
		catch (Exception e) {
			_finishBatchJob(jobExecution.getBatchJob(), BatchStatus.FAILED);
