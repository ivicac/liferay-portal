...
package com.liferay.batch.engine.core.internal.batch;

import com.liferay.batch.engine.core.batch.BatchFileProcessor;
import com.liferay.batch.engine.core.exception.NoSuchItemException;
import com.liferay.batch.engine.core.item.ItemComponent;
import com.liferay.batch.engine.core.item.ItemComponentFactory;
import com.liferay.batch.engine.core.item.ItemReader;
import com.liferay.batch.engine.core.item.ItemRegistry;
import com.liferay.batch.engine.core.item.ItemWriter;
...
public class BatchFileProcessorImpl implements BatchFileProcessor {
	...
	public Map<String, String> process(String fileName, InputStream inputStream)
		...
		for (Job job : jobs) {
			...
			jobKeyNameMap.put(batchJob.getKey(), batchJob.getName());
		}
