...
/**
 * Provides the local service interface for BatchJob. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Matija Petanjek
 * @see BatchJobLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BatchJobLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BatchJobLocalServiceUtil} to access the batch job local service. Add custom service methods to <code>com.liferay.batch.engine.service.impl.BatchJobLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
