...
/**
 * The base model interface for the BatchJob service. Represents a row in the &quot;BatchJob&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.batch.engine.model.impl.BatchJobModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.batch.engine.model.impl.BatchJobImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface BatchJobModel extends BaseModel<BatchJob> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a batch job model instance should use the {@link BatchJob} interface instead.
	 */
